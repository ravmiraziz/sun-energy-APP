            ...
            <table className="w-full text-left">
              ...
              <tbody className="">
                {dashboard?.top_products.map((tx, i) => (
                  ...
                  >
                    <td className="px-6 py-4 font-bold text-sm">{tx.name}</td>
