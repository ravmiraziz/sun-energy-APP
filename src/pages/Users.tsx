  ...
  return (
    <div className="p-8 max-w-400 mx-auto w-full space-y-8">
      <div className="flex flex-wrap justify-between items-center gap-4">
        ...
        <button className="flex items-center justify-center gap-2 px-6 py-3 bg-primary rounded-xl font-bold text-sm tracking-tight hover:brightness-110 shadow-lg shadow-primary/20 transition-all transform hover:scale-[1.02]">
          <MdPersonAdd />
          Create New User
        </button>
      </div>
      ...
      <div className="bg_card p-4 rounded-2xl border border_color flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button className="flex h-12 items-center justify-center gap-2 rounded-xl card_btn px-5 border border-transparent hover:border-primary/30 text-white text-sm font-medium transition-all">
            All Roles <MdExpandMore />
          </button>
          <button className="flex h-12 items-center justify-center gap-2 rounded-xl card_btn px-5 border border-transparent hover:border-primary/30 text-white text-sm font-medium transition-all">
            Status: Active <MdExpandMore />
          </button>
        </div>
      </div>
